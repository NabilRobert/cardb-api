...
<template>
  <div class="max-w-3xl">
    ...
    <p class="text-sm text-gray-500 mb-8">
      ...
      requires an <code class="text-xs bg-gray-200 px-1 rounded">X-API-Key</code> header. The key itself is fetched by the frontend
    ...
    <section class="mb-10">
      <div class="flex items-center gap-2 mb-2">
        <span class="text-xs font-mono bg-blue-100 text-blue-800 px-2 py-0.5 rounded">GET</span>
      ...
      <table class="w-full text-sm border-collapse mb-4">
        <tbody>
          <tr class="border-b border-gray-200">
            ...
            <td class="py-1.5 text-gray-700">Required. URL-encoded query parameter -- the question in plain English.</td>
          </tr>
          <tr>
      ...
      <pre class="bg-gray-900 text-gray-100 text-xs p-3 rounded overflow-x-auto mb-4">curl "http://localhost:3000/api/ask?question=How+many+Hondas+are+in+stock%3F" \
...
{ "apiKey": "..." }</pre>
    ...
    <section class="mb-8">
      ...
      <p class="text-sm text-gray-600 mb-2">
        ...
        "SMR" sheets, and inserts the results into the database.
      </p>
